...
class PhocaDownloadCpControllerPhocaDownloadUnit extends JControllerForm
{
	...
	public function batch() {
		...
		// Set the model
		$model	= $this->getModel('phocadownloadunit', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_phocadownload&view=phocadownloadunits'.$this->getRedirectToListAppend(), false));
