...
class PhocaDownloadCpControllerPhocaDownloadLocation extends JControllerForm
{
	...
	public function batch() {
		...
		// Set the model
		$model	= $this->getModel('phocadownloadlocation', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_phocadownload&view=phocadownloadlocations'.$this->getRedirectToListAppend(), false));
