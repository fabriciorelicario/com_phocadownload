...
class PhocaDownloadCpControllerPhocaDownloadEntitle extends JControllerForm
{
	...
	public function batch() {
		...
		// Set the model
		$model	= $this->getModel('phocadownloadentitle', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_phocadownload&view=phocadownloadentitles'.$this->getRedirectToListAppend(), false));
