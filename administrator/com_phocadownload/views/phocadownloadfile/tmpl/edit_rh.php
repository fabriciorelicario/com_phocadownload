...
//    }
    ...
    Joomla.submitbutton = function(task)
        {
                if (task == 'phocadownloadfile.cancel' || document.formvalidator.isValid(document.id('phocadownloadfile-form'))) {
                        Joomla.submitform(task, document.getElementById('phocadownloadfile-form'));
                }
                else {
                        alert('<?php echo $this->escape(JText::_('JGLOBAL_VALIDATION_FORM_FAILED'));?>');
    ...
    <div class="width-60 fltlft">
        ...
        <fieldset class="adminform">
            ...
            <ul class="adminformlist">
                ...
                $formArray = array('title_id','title', 'alias', 'catid', 'type', 'status', 'ordering',
                    'filename');
