...
<form action="<?php echo JRoute::_('index.php?option=com_phocadownload&view=phocadownloadunits'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="adminlist">
            <thead>
                <tr>
                    ...
                    <th class="title" width="5%"><?php echo JText::_('COM_PHOCADOWNLOAD_IMAGE'); ?>
                    </th>
                    <th class="title" width="25%"><?php echo JHTML::_('grid.sort', 'COM_PHOCADOWNLOAD_TITLE', 'a.title', $listDirn, $listOrder); ?>
                    </th>
                    <th class="title" width="10%"><?php echo JHTML::_('grid.sort', 'COM_PHOCADOWNLOAD_SHORT_TITLE', 'a.short_title', $listDirn, $listOrder); ?>
                    </th>
            ...
            <tbody>
                ...
                if (is_array($this->items)) {
                    foreach ($this->items as $i => $item) {
                        ...
                        $linkEdit = JRoute::_('index.php?option=com_phocadownload&task=phocadownloadunit.edit&id=' . (int) $item->id);
                        $image_unit = ($this->escape($item->image_unit) != '')?'../'.$this->escape($item->image_unit):'http://placehold.it/138x71&text=Image';

                        echo '<tr class="row' . $i % 2 . '">';

                        echo '<td class="center">' . JHtml::_('grid.id', $i, $item->id) . '</td>';

                        echo '<td><img width="100" src="'.$image_unit.'" /></td>';
                        ...
                        echo '</td>';
                        echo '<td class="center">'.$this->escape($item->short_title).'</td>';
