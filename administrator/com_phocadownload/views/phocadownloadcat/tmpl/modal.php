...
<form action="<?php JRoute::_('index.php?option=com_phocadownload'); ?>" method="post" name="adminForm" id="phocadownloadcat-form" class="form-validate">
        <fieldset>
		<div class="fltrt">
			<button onclick="Joomla.submitform('phocadownloadcat.apply', this.form);" type="button">
				Salvar</button>
			<button onclick="Joomla.submitform('phocadownloadcat.save', this.form);" type="button">
				Salvar &amp; Fechar</button>
			<button onclick="  window.parent.SqueezeBox.close();" type="button">
				Cancelar</button>
		</div>
                <div class="pagetitle icon-48-category"><h2>Categoria: <small><small>[ Editar ]</small></small></h2></div>
	</fieldset>
	<div class="width-60 fltlft">
		...
		<ul class="adminformlist">
			<?php 
			$formArray = array ('title', 'alias', 'parent_id', 'type','ordering',
