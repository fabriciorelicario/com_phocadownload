...
<script type="text/javascript">
	...
	{
		if (task == 'phocadownloadlocation.cancel' || document.formvalidator.isValid(document.id('phocadownloadlocation-form'))) {
			Joomla.submitform(task, document.getElementById('phocadownloadlocation-form'));
		}
		else {
...
<form action="<?php JRoute::_('index.php?option=com_phocadownload'); ?>" method="post" name="adminForm" id="phocadownloadlocation-form" class="form-validate">
	<div class="width-60 fltlft">
		...
		<ul class="adminformlist">
			...
			$formArray = array ('title', 'alias', 'ordering','access','id','params');
