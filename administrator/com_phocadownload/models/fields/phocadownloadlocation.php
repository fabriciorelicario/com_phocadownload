...
class JFormFieldPhocaDownloadLocation extends JFormField
{
   protected $type = 'PhocaDownloadLocation';
   ...
   protected function getInput() {
      ...
      $query = 'SELECT a.title , a.id , a.alias'
      . ' FROM #__phocadownload_locations AS a'
      . ' WHERE a.published = 1'
      . ' ORDER BY a.ordering';
      $db->setQuery( $query );
